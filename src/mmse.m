% mmse - Calculates the Mean Squared Error (MSE) of an Bayesian MMSE Estimator
...
function estimator_mse = mmse(theta, m_theta, sigma_theta, h, m_w, sigma_w, N_max, Exp_per_N)
