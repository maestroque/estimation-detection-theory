% mle_implementation - Calculates the Mean Squared Error (MSE) of an MLE Estimator
...
function estimator_mse = mle_implementation(theta, h, m_w, sigma_w, N_max, Exp_per_N)
